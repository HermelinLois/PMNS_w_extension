...
#define prod_pol_mat(RETURN_TYPE, RESULT, POLYNOMIAL, MATRIX){	\
...
//void reduction_montgomery_mpn(int n_limbs, mp_limb_t out[DEGREE][n_limbs], mp_limb_t abs_polynomial[DEGREE][n_limbs], int coeffs_sign[DEGREE], const int64_t sublattice[DEGREE][DEGREE], const int64_t sublattice_inv[DEGREE][DEGREE]);
